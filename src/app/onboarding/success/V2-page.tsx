...
export default function OnboardingSuccess() {
  ...
  return (
    <div className="relative min-h-screen bg-slate-950 flex flex-col justify-center items-center overflow-hidden font-sans text-white">
      ...
      {/* Subtle Radial Gold Halo Background Accent */}
      <div 
        className={`absolute w-[600px] h-[600px] bg-[#C5A059]/10 rounded-full blur-[120px] pointer-events-none z-10 transition-opacity duration-1000 ${
      ...
      >
        ...
        >
          ...
          <h1 className="text-3xl font-light text-white tracking-wide font-serif">
          ...
          <p className="text-sm text-slate-400 leading-relaxed max-w-md mx-auto pt-2">
            Your corporate entity, infrastructure parameters, and operational preferences have been successfully verified. Your custom portal is live.
          </p>
        </div>
