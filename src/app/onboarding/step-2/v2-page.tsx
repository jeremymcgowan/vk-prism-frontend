...
export default function StepTwoIdentity() {
  ...
  const [formData, setFormData] = useState({
    legal_structure: 'DELAWARE_C_CORP',
    formation_year: '',
    hq_address_line_1: '',
    hq_city: '',
    hq_state: '',
        ...
        <div className="w-full max-w-2xl bg-slate-900 border border-slate-800 shadow-2xl rounded-2xl p-10 my-8 relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            <h2 className="text-xs font-bold tracking-widest text-emerald-400 uppercase mb-2">
              Step 2 of 6: Identity & Infrastructure — Scroll to bottom for Co-Working and Virtual Office Interest
            </h2>
          ...
          <form onSubmit={handleStandardNext} className="space-y-6">
            ...
            {/* Address Skip Checkbox with Tooltip */}
            <div className="pt-2">
          ...
          {/* Rebranded Co-Working & Virtual Office Card */}
          <button
